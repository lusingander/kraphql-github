...
Current version: based on the [schema 2020-11-13](https://docs.github.com/en/free-pro-team@latest/graphql/overview/changelog#schema-changes-for-2020-11-13).
...
dependencies {
    implementation 'com.github.lusingander:kraphql-github:0.0.3'
}
```
