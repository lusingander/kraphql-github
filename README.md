...
Current version: based on the [schema 2022-06-13](https://docs.github.com/en/free-pro-team@latest/graphql/overview/changelog#schema-changes-for-2022-06-13).
...
dependencies {
    implementation 'com.github.lusingander:kraphql-github:v0.0.29'
}
```
