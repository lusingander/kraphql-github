...
Current version: based on the [schema 2021-02-25](https://docs.github.com/en/free-pro-team@latest/graphql/overview/changelog#schema-changes-for-2021-02-25).
...
dependencies {
    implementation 'com.github.lusingander:kraphql-github:0.0.8'
}
```
