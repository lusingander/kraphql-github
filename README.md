...
Current version: based on the [schema 2022-01-04](https://docs.github.com/en/free-pro-team@latest/graphql/overview/changelog#schema-changes-for-2020-01-04).
...
dependencies {
    implementation 'com.github.lusingander:kraphql-github:v0.0.25'
}
```
