...
Current version: based on the [schema 2023-02-11](https://docs.github.com/en/free-pro-team@latest/graphql/overview/changelog#schema-changes-for-2023-02-11).
...
dependencies {
    implementation 'com.github.lusingander:kraphql-github:v0.0.32'
}
```
