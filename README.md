...
Current version: based on the [schema 2021-06-18](https://docs.github.com/en/free-pro-team@latest/graphql/overview/changelog#schema-changes-for-2021-06-18).
...
dependencies {
    implementation 'com.github.lusingander:kraphql-github:v0.0.18'
}
```
