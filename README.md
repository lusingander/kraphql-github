...
Current version: based on the [schema 2021-08-19](https://docs.github.com/en/free-pro-team@latest/graphql/overview/changelog#schema-changes-for-2021-08-19).
...
dependencies {
    implementation 'com.github.lusingander:kraphql-github:v0.0.24'
}
```
