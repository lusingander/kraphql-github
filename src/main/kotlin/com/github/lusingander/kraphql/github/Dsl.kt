...
enum class DependencyGraphEcosystem {
    ACTIONS,
    COMPOSER,
    GO,
    MAVEN,
...
enum class SponsorsActivityAction {
...
enum class SponsorsActivityOrderField {
    TIMESTAMP,
    ;
}

enum class SponsorsActivityPeriod {
    ALL,
    DAY,
    MONTH,
    WEEK,
...
class BranchProtectionRule(__name: String = "BranchProtectionRule"): ObjectNode(__name) {
    ...
    fun bypassForcePushAllowances(after: String? = null, before: String? = null, first: Int? = null, last: Int? = null, init: BypassForcePushAllowanceConnection.() -> Unit) =
        BypassForcePushAllowanceConnection("bypassForcePushAllowances").apply { addArgs("after", after) }.apply { addArgs("before", before) }.apply { addArgs("first", first) }.apply { addArgs("last", last) }.also { doInit(it, init) }
    fun bypassPullRequestAllowances(after: String? = null, before: String? = null, first: Int? = null, last: Int? = null, init: BypassPullRequestAllowanceConnection.() -> Unit) =
        BypassPullRequestAllowanceConnection("bypassPullRequestAllowances").apply { addArgs("after", after) }.apply { addArgs("before", before) }.apply { addArgs("first", first) }.apply { addArgs("last", last) }.also { doInit(it, init) }
    ...
    fun requiredStatusChecks(init: RequiredStatusCheckDescription.() -> Unit) =
        RequiredStatusCheckDescription("requiredStatusChecks").also { doInit(it, init) }
...
class BypassForcePushAllowance(__name: String = "BypassForcePushAllowance"): ObjectNode(__name) {
    fun actor(init: BranchActorAllowanceActor.() -> Unit) =
        BranchActorAllowanceActor("actor").also { doInit(it, init) }
    fun branchProtectionRule(init: BranchProtectionRule.() -> Unit) =
        BranchProtectionRule("branchProtectionRule").also { doInit(it, init) }
    val id get() =
        ScalarNode("id").also { doInit(it) }
...
class BypassForcePushAllowanceConnection(__name: String = "BypassForcePushAllowanceConnection"): ObjectNode(__name) {
    fun edges(init: BypassForcePushAllowanceEdge.() -> Unit) =
        BypassForcePushAllowanceEdge("edges").also { doInit(it, init) }
    fun nodes(init: BypassForcePushAllowance.() -> Unit) =
        BypassForcePushAllowance("nodes").also { doInit(it, init) }
    fun pageInfo(init: PageInfo.() -> Unit) =
        PageInfo("pageInfo").also { doInit(it, init) }
    val totalCount get() =
        ScalarNode("totalCount").also { doInit(it) }
...
class BypassForcePushAllowanceEdge(__name: String = "BypassForcePushAllowanceEdge"): ObjectNode(__name) {
    val cursor get() =
        ScalarNode("cursor").also { doInit(it) }
    fun node(init: BypassForcePushAllowance.() -> Unit) =
        BypassForcePushAllowance("node").also { doInit(it, init) }
}

class BypassPullRequestAllowance(__name: String = "BypassPullRequestAllowance"): ObjectNode(__name) {
    fun actor(init: BranchActorAllowanceActor.() -> Unit) =
        BranchActorAllowanceActor("actor").also { doInit(it, init) }
    fun branchProtectionRule(init: BranchProtectionRule.() -> Unit) =
        BranchProtectionRule("branchProtectionRule").also { doInit(it, init) }
...
class BypassPullRequestAllowanceConnection(__name: String = "BypassPullRequestAllowanceConnection"): ObjectNode(__name) {
    fun edges(init: BypassPullRequestAllowanceEdge.() -> Unit) =
        BypassPullRequestAllowanceEdge("edges").also { doInit(it, init) }
    fun nodes(init: BypassPullRequestAllowance.() -> Unit) =
        BypassPullRequestAllowance("nodes").also { doInit(it, init) }
    fun pageInfo(init: PageInfo.() -> Unit) =
        PageInfo("pageInfo").also { doInit(it, init) }
    val totalCount get() =
        ScalarNode("totalCount").also { doInit(it) }
...
class BypassPullRequestAllowanceEdge(__name: String = "BypassPullRequestAllowanceEdge"): ObjectNode(__name) {
    val cursor get() =
        ScalarNode("cursor").also { doInit(it) }
    fun node(init: BypassPullRequestAllowance.() -> Unit) =
        BypassPullRequestAllowance("node").also { doInit(it, init) }
}
...
class CancelSponsorshipPayload(__name: String = "CancelSponsorshipPayload"): ObjectNode(__name) {
    val clientMutationId get() =
        ScalarNode("clientMutationId").also { doInit(it) }
...
class ConvertedToDiscussionEvent(__name: String = "ConvertedToDiscussionEvent"): ObjectNode(__name) {
    fun actor(init: Actor.() -> Unit) =
        Actor("actor").also { doInit(it, init) }
    val createdAt get() =
        ScalarNode("createdAt").also { doInit(it) }
...
class CreateCommitOnBranchPayload(__name: String = "CreateCommitOnBranchPayload"): ObjectNode(__name) {
    val clientMutationId get() =
        ScalarNode("clientMutationId").also { doInit(it) }
    fun commit(init: Commit.() -> Unit) =
        Commit("commit").also { doInit(it, init) }
...
class DismissRepositoryVulnerabilityAlertPayload(__name: String = "DismissRepositoryVulnerabilityAlertPayload"): ObjectNode(__name) {
    val clientMutationId get() =
        ScalarNode("clientMutationId").also { doInit(it) }
    fun repositoryVulnerabilityAlert(init: RepositoryVulnerabilityAlert.() -> Unit) =
...
class Enterprise(__name: String = "Enterprise"): ObjectNode(__name) {
    ...
    fun organizations(after: String? = null, before: String? = null, first: Int? = null, last: Int? = null, orderBy: OrganizationOrder? = null, query: String? = null, viewerOrganizationRole: RoleInOrganization? = null, init: OrganizationConnection.() -> Unit) =
        OrganizationConnection("organizations").apply { addArgs("after", after) }.apply { addArgs("before", before) }.apply { addArgs("first", first) }.apply { addArgs("last", last) }.apply { addArgs("orderBy", orderBy) }.apply { addArgs("query", query) }.apply { addArgs("viewerOrganizationRole", viewerOrganizationRole) }.also { doInit(it, init) }
...
class EnterpriseOwnerInfo(__name: String = "EnterpriseOwnerInfo"): ObjectNode(__name) {
    ...
    fun oidcProvider(init: OIDCProvider.() -> Unit) =
        OIDCProvider("oidcProvider").also { doInit(it, init) }
...
class Mutation(__name: String = "mutation"): ObjectNode(__name) {
    ...
    fun cancelSponsorship(input: CancelSponsorshipInput, init: CancelSponsorshipPayload.() -> Unit) =
        CancelSponsorshipPayload("cancelSponsorship").apply { addArgs("input", input) }.also { doInit(it, init) }
    ...
    fun createCommitOnBranch(input: CreateCommitOnBranchInput, init: CreateCommitOnBranchPayload.() -> Unit) =
        CreateCommitOnBranchPayload("createCommitOnBranch").apply { addArgs("input", input) }.also { doInit(it, init) }
    ...
    fun dismissRepositoryVulnerabilityAlert(input: DismissRepositoryVulnerabilityAlertInput, init: DismissRepositoryVulnerabilityAlertPayload.() -> Unit) =
    ...
    fun updatePullRequestBranch(input: UpdatePullRequestBranchInput, init: UpdatePullRequestBranchPayload.() -> Unit) =
        UpdatePullRequestBranchPayload("updatePullRequestBranch").apply { addArgs("input", input) }.also { doInit(it, init) }
...
class OIDCProvider(__name: String = "OIDCProvider"): ObjectNode(__name) {
    ...
    val providerType get() =
        ScalarNode("providerType").also { doInit(it) }
    val tenantId get() =
        ScalarNode("tenantId").also { doInit(it) }
}
...
class Organization(__name: String = "Organization"): ObjectNode(__name) {
    ...
    val membersCanForkPrivateRepositories get() =
        ScalarNode("membersCanForkPrivateRepositories").also { doInit(it) }
    ...
    fun repository(followRenames: Boolean? = null, name: String, init: Repository.() -> Unit) =
        Repository("repository").apply { addArgs("followRenames", followRenames) }.apply { addArgs("name", name) }.also { doInit(it, init) }
    ...
    fun sponsorshipForViewerAsSponsorable(init: Sponsorship.() -> Unit) =
        Sponsorship("sponsorshipForViewerAsSponsorable").also { doInit(it, init) }
...
class ProjectNextConnection(__name: String = "ProjectNextConnection"): ObjectNode(__name) {
    fun edges(init: ProjectNextEdge.() -> Unit) =
        ProjectNextEdge("edges").also { doInit(it, init) }
    fun nodes(init: ProjectNext.() -> Unit) =
        ProjectNext("nodes").also { doInit(it, init) }
    fun pageInfo(init: PageInfo.() -> Unit) =
        PageInfo("pageInfo").also { doInit(it, init) }
    val totalCount get() =
        ScalarNode("totalCount").also { doInit(it) }
...
class ProjectNextEdge(__name: String = "ProjectNextEdge"): ObjectNode(__name) {
    val cursor get() =
        ScalarNode("cursor").also { doInit(it) }
    fun node(init: ProjectNext.() -> Unit) =
        ProjectNext("node").also { doInit(it, init) }
}
...
class ProjectNextFieldConnection(__name: String = "ProjectNextFieldConnection"): ObjectNode(__name) {
    fun edges(init: ProjectNextFieldEdge.() -> Unit) =
        ProjectNextFieldEdge("edges").also { doInit(it, init) }
    fun nodes(init: ProjectNextField.() -> Unit) =
        ProjectNextField("nodes").also { doInit(it, init) }
    fun pageInfo(init: PageInfo.() -> Unit) =
        PageInfo("pageInfo").also { doInit(it, init) }
    val totalCount get() =
        ScalarNode("totalCount").also { doInit(it) }
...
class ProjectNextFieldEdge(__name: String = "ProjectNextFieldEdge"): ObjectNode(__name) {
    val cursor get() =
        ScalarNode("cursor").also { doInit(it) }
    fun node(init: ProjectNextField.() -> Unit) =
        ProjectNextField("node").also { doInit(it, init) }
}
...
class ProjectNextItemConnection(__name: String = "ProjectNextItemConnection"): ObjectNode(__name) {
    fun edges(init: ProjectNextItemEdge.() -> Unit) =
        ProjectNextItemEdge("edges").also { doInit(it, init) }
    fun nodes(init: ProjectNextItem.() -> Unit) =
        ProjectNextItem("nodes").also { doInit(it, init) }
    fun pageInfo(init: PageInfo.() -> Unit) =
        PageInfo("pageInfo").also { doInit(it, init) }
    val totalCount get() =
        ScalarNode("totalCount").also { doInit(it) }
...
class ProjectNextItemEdge(__name: String = "ProjectNextItemEdge"): ObjectNode(__name) {
    val cursor get() =
        ScalarNode("cursor").also { doInit(it) }
    fun node(init: ProjectNextItem.() -> Unit) =
        ProjectNextItem("node").also { doInit(it, init) }
}
...
class ProjectNextItemFieldValueConnection(__name: String = "ProjectNextItemFieldValueConnection"): ObjectNode(__name) {
    fun edges(init: ProjectNextItemFieldValueEdge.() -> Unit) =
        ProjectNextItemFieldValueEdge("edges").also { doInit(it, init) }
    fun nodes(init: ProjectNextItemFieldValue.() -> Unit) =
        ProjectNextItemFieldValue("nodes").also { doInit(it, init) }
    fun pageInfo(init: PageInfo.() -> Unit) =
        PageInfo("pageInfo").also { doInit(it, init) }
    val totalCount get() =
        ScalarNode("totalCount").also { doInit(it) }
...
class ProjectNextItemFieldValueEdge(__name: String = "ProjectNextItemFieldValueEdge"): ObjectNode(__name) {
    val cursor get() =
        ScalarNode("cursor").also { doInit(it) }
    fun node(init: ProjectNextItemFieldValue.() -> Unit) =
        ProjectNextItemFieldValue("node").also { doInit(it, init) }
}
...
class PullRequest(__name: String = "PullRequest"): ObjectNode(__name) {
    ...
    val closedAt get() =
        ScalarNode("closedAt").also { doInit(it) }
    fun closingIssuesReferences(after: String? = null, before: String? = null, first: Int? = null, last: Int? = null, orderBy: IssueOrder? = null, userLinkedOnly: Boolean? = null, init: IssueConnection.() -> Unit) =
        IssueConnection("closingIssuesReferences").apply { addArgs("after", after) }.apply { addArgs("before", before) }.apply { addArgs("first", first) }.apply { addArgs("last", last) }.apply { addArgs("orderBy", orderBy) }.apply { addArgs("userLinkedOnly", userLinkedOnly) }.also { doInit(it, init) }
    fun comments(after: String? = null, before: String? = null, first: Int? = null, last: Int? = null, orderBy: IssueCommentOrder? = null, init: IssueCommentConnection.() -> Unit) =
        IssueCommentConnection("comments").apply { addArgs("after", after) }.apply { addArgs("before", before) }.apply { addArgs("first", first) }.apply { addArgs("last", last) }.apply { addArgs("orderBy", orderBy) }.also { doInit(it, init) }
    ...
    val viewerCanMergeAsAdmin get() =
        ScalarNode("viewerCanMergeAsAdmin").also { doInit(it) }
    val viewerCanReact get() =
        ScalarNode("viewerCanReact").also { doInit(it) }
    val viewerCanSubscribe get() =
        ScalarNode("viewerCanSubscribe").also { doInit(it) }
...
class Push(__name: String = "Push"): ObjectNode(__name) {
    ...
    fun pusher(init: Actor.() -> Unit) =
        Actor("pusher").also { doInit(it, init) }
    fun repository(init: Repository.() -> Unit) =
        Repository("repository").also { doInit(it, init) }
}
...
class Query(__name: String = "query"): ObjectNode(__name) {
    ...
    fun repository(followRenames: Boolean? = null, name: String, owner: String, init: Repository.() -> Unit) =
        Repository("repository").apply { addArgs("followRenames", followRenames) }.apply { addArgs("name", name) }.apply { addArgs("owner", owner) }.also { doInit(it, init) }
...
class Repository(__name: String = "Repository"): ObjectNode(__name) {
    ...
    fun codeowners(refName: String? = null, init: RepositoryCodeowners.() -> Unit) =
        RepositoryCodeowners("codeowners").apply { addArgs("refName", refName) }.also { doInit(it, init) }
    ...
    val forkingAllowed get() =
        ScalarNode("forkingAllowed").also { doInit(it) }
...
class RepositoryCodeowners(__name: String = "RepositoryCodeowners"): ObjectNode(__name) {
    fun errors(init: RepositoryCodeownersError.() -> Unit) =
        RepositoryCodeownersError("errors").also { doInit(it, init) }
}

class RepositoryCodeownersError(__name: String = "RepositoryCodeownersError"): ObjectNode(__name) {
    val column get() =
        ScalarNode("column").also { doInit(it) }
    val kind get() =
    ...
    val path get() =
        ScalarNode("path").also { doInit(it) }
    val source get() =
        ScalarNode("source").also { doInit(it) }
    val suggestion get() =
        ScalarNode("suggestion").also { doInit(it) }
}
...
class RepositoryVulnerabilityAlert(__name: String = "RepositoryVulnerabilityAlert"): ObjectNode(__name) {
    ...
    val fixedAt get() =
        ScalarNode("fixedAt").also { doInit(it) }
    val id get() =
        ScalarNode("id").also { doInit(it) }
    val number get() =
        ScalarNode("number").also { doInit(it) }
...
class SponsorsActivity(__name: String = "SponsorsActivity"): ObjectNode(__name) {
    val action get() =
        ScalarNode("action").also { doInit(it) }
    val id get() =
        ScalarNode("id").also { doInit(it) }
    fun previousSponsorsTier(init: SponsorsTier.() -> Unit) =
        SponsorsTier("previousSponsorsTier").also { doInit(it, init) }
    fun sponsor(init: Sponsor.() -> Unit) =
        Sponsor("sponsor").also { doInit(it, init) }
    fun sponsorable(init: Sponsorable.() -> Unit) =
        Sponsorable("sponsorable").also { doInit(it, init) }
    fun sponsorsTier(init: SponsorsTier.() -> Unit) =
        SponsorsTier("sponsorsTier").also { doInit(it, init) }
    val timestamp get() =
        ScalarNode("timestamp").also { doInit(it) }
}

class SponsorsActivityConnection(__name: String = "SponsorsActivityConnection"): ObjectNode(__name) {
    fun edges(init: SponsorsActivityEdge.() -> Unit) =
        SponsorsActivityEdge("edges").also { doInit(it, init) }
    fun nodes(init: SponsorsActivity.() -> Unit) =
        SponsorsActivity("nodes").also { doInit(it, init) }
    fun pageInfo(init: PageInfo.() -> Unit) =
        PageInfo("pageInfo").also { doInit(it, init) }
    val totalCount get() =
        ScalarNode("totalCount").also { doInit(it) }
...
class SponsorsActivityEdge(__name: String = "SponsorsActivityEdge"): ObjectNode(__name) {
    val cursor get() =
        ScalarNode("cursor").also { doInit(it) }
    fun node(init: SponsorsActivity.() -> Unit) =
        SponsorsActivity("node").also { doInit(it, init) }
}
...
class SponsorsTier(__name: String = "SponsorsTier"): ObjectNode(__name) {
    ...
    fun closestLesserValueTier(init: SponsorsTier.() -> Unit) =
        SponsorsTier("closestLesserValueTier").also { doInit(it, init) }
    val createdAt get() =
        ScalarNode("createdAt").also { doInit(it) }
    val description get() =
        ScalarNode("description").also { doInit(it) }
    ...
    val id get() =
        ScalarNode("id").also { doInit(it) }
    val isCustomAmount get() =
        ScalarNode("isCustomAmount").also { doInit(it) }
    val isOneTime get() =
        ScalarNode("isOneTime").also { doInit(it) }
...
class Sponsorship(__name: String = "Sponsorship"): ObjectNode(__name) {
    ...
    val id get() =
        ScalarNode("id").also { doInit(it) }
    val isOneTimePayment get() =
        ScalarNode("isOneTimePayment").also { doInit(it) }
    val isSponsorOptedIntoEmail get() =
        ScalarNode("isSponsorOptedIntoEmail").also { doInit(it) }
...
class Topic(__name: String = "Topic"): ObjectNode(__name) {
    ...
    fun repositories(affiliations: RepositoryAffiliation? = null, after: String? = null, before: String? = null, first: Int? = null, isLocked: Boolean? = null, last: Int? = null, orderBy: RepositoryOrder? = null, ownerAffiliations: RepositoryAffiliation? = null, privacy: RepositoryPrivacy? = null, sponsorableOnly: Boolean? = null, init: RepositoryConnection.() -> Unit) =
        RepositoryConnection("repositories").apply { addArgs("affiliations", affiliations) }.apply { addArgs("after", after) }.apply { addArgs("before", before) }.apply { addArgs("first", first) }.apply { addArgs("isLocked", isLocked) }.apply { addArgs("last", last) }.apply { addArgs("orderBy", orderBy) }.apply { addArgs("ownerAffiliations", ownerAffiliations) }.apply { addArgs("privacy", privacy) }.apply { addArgs("sponsorableOnly", sponsorableOnly) }.also { doInit(it, init) }
    val stargazerCount get() =
        ScalarNode("stargazerCount").also { doInit(it) }
    fun stargazers(after: String? = null, before: String? = null, first: Int? = null, last: Int? = null, orderBy: StarOrder? = null, init: StargazerConnection.() -> Unit) =
        StargazerConnection("stargazers").apply { addArgs("after", after) }.apply { addArgs("before", before) }.apply { addArgs("first", first) }.apply { addArgs("last", last) }.apply { addArgs("orderBy", orderBy) }.also { doInit(it, init) }
...
class UpdateOrganizationAllowPrivateRepositoryForkingSettingPayload(__name: String = "UpdateOrganizationAllowPrivateRepositoryForkingSettingPayload"): ObjectNode(__name) {
    val clientMutationId get() =
        ScalarNode("clientMutationId").also { doInit(it) }
    val message get() =
        ScalarNode("message").also { doInit(it) }
...
class UpdateSponsorshipPreferencesPayload(__name: String = "UpdateSponsorshipPreferencesPayload"): ObjectNode(__name) {
    val clientMutationId get() =
        ScalarNode("clientMutationId").also { doInit(it) }
    fun sponsorship(init: Sponsorship.() -> Unit) =
        Sponsorship("sponsorship").also { doInit(it, init) }
...
class User(__name: String = "User"): ObjectNode(__name) {
    ...
    val isFollowingViewer get() =
        ScalarNode("isFollowingViewer").also { doInit(it) }
...
class Node(__name: String = "Node"): ObjectNode(__name) {
    ...
    fun `on BypassForcePushAllowance`(init: BypassForcePushAllowance.() -> Unit) =
        BypassForcePushAllowance("...on BypassForcePushAllowance").also { doInit(it, init) }
    fun `on BypassPullRequestAllowance`(init: BypassPullRequestAllowance.() -> Unit) =
        BypassPullRequestAllowance("...on BypassPullRequestAllowance").also { doInit(it, init) }
    ...
    fun `on ConvertedToDiscussionEvent`(init: ConvertedToDiscussionEvent.() -> Unit) =
        ConvertedToDiscussionEvent("...on ConvertedToDiscussionEvent").also { doInit(it, init) }
    ...
    fun `on OIDCProvider`(init: OIDCProvider.() -> Unit) =
        OIDCProvider("...on OIDCProvider").also { doInit(it, init) }
    fun `on OauthApplicationCreateAuditEntry`(init: OauthApplicationCreateAuditEntry.() -> Unit) =
        OauthApplicationCreateAuditEntry("...on OauthApplicationCreateAuditEntry").also { doInit(it, init) }
    fun `on OrgAddBillingManagerAuditEntry`(init: OrgAddBillingManagerAuditEntry.() -> Unit) =
        OrgAddBillingManagerAuditEntry("...on OrgAddBillingManagerAuditEntry").also { doInit(it, init) }
    ...
    fun `on SponsorsActivity`(init: SponsorsActivity.() -> Unit) =
        SponsorsActivity("...on SponsorsActivity").also { doInit(it, init) }
...
class CancelSponsorshipInput(val clientMutationId: String? = null, val sponsorId: ID? = null, val sponsorLogin: String? = null, val sponsorableId: ID? = null, val sponsorableLogin: String? = null) {
    override fun toString() = "{ clientMutationId: \"$clientMutationId\", sponsorId: \"$sponsorId\", sponsorLogin: \"$sponsorLogin\", sponsorableId: \"$sponsorableId\", sponsorableLogin: \"$sponsorableLogin\" }"
}
...
class CommitMessage(val body: String? = null, val headline: String) {
    override fun toString() = "{ body: \"$body\", headline: \"$headline\" }"
}

class CommittableBranch(val branchName: String? = null, val id: ID? = null, val repositoryNameWithOwner: String? = null) {
    override fun toString() = "{ branchName: \"$branchName\", id: \"$id\", repositoryNameWithOwner: \"$repositoryNameWithOwner\" }"
}
...
class CreateCommitOnBranchInput(val branch: CommittableBranch, val clientMutationId: String? = null, val expectedHeadOid: GitObjectID, val fileChanges: FileChanges? = null, val message: CommitMessage) {
    override fun toString() = "{ branch: $branch, clientMutationId: \"$clientMutationId\", expectedHeadOid: \"$expectedHeadOid\", fileChanges: $fileChanges, message: $message }"
}
...
class CreateSponsorshipInput(val amount: Int? = null, val clientMutationId: String? = null, val isRecurring: Boolean? = null, val privacyLevel: SponsorshipPrivacy? = null, val receiveEmails: Boolean? = null, val sponsorId: ID? = null, val sponsorLogin: String? = null, val sponsorableId: ID? = null, val sponsorableLogin: String? = null, val tierId: ID? = null) {
    override fun toString() = "{ amount: $amount, clientMutationId: \"$clientMutationId\", isRecurring: $isRecurring, privacyLevel: $privacyLevel, receiveEmails: $receiveEmails, sponsorId: \"$sponsorId\", sponsorLogin: \"$sponsorLogin\", sponsorableId: \"$sponsorableId\", sponsorableLogin: \"$sponsorableLogin\", tierId: \"$tierId\" }"
}
...
class DismissRepositoryVulnerabilityAlertInput(val clientMutationId: String? = null, val dismissReason: DismissReason, val repositoryVulnerabilityAlertId: ID) {
    override fun toString() = "{ clientMutationId: \"$clientMutationId\", dismissReason: $dismissReason, repositoryVulnerabilityAlertId: \"$repositoryVulnerabilityAlertId\" }"
}
...
class FileAddition(val contents: Base64String, val path: String) {
    override fun toString() = "{ contents: \"$contents\", path: \"$path\" }"
}

class FileChanges(val additions: FileAddition? = null, val deletions: FileDeletion? = null) {
    override fun toString() = "{ additions: $additions, deletions: $deletions }"
}
...
class IssueFilters(val assignee: String? = null, val createdBy: String? = null, val labels: String? = null, val mentioned: String? = null, val milestone: String? = null, val milestoneNumber: String? = null, val since: DateTime? = null, val states: IssueState? = null, val viewerSubscribed: Boolean? = null) {
    override fun toString() = "{ assignee: \"$assignee\", createdBy: \"$createdBy\", labels: \"$labels\", mentioned: \"$mentioned\", milestone: \"$milestone\", milestoneNumber: \"$milestoneNumber\", since: \"$since\", states: $states, viewerSubscribed: $viewerSubscribed }"
}
...
class RequiredStatusCheckInput(val appId: ID? = null, val context: String) {
    override fun toString() = "{ appId: \"$appId\", context: \"$context\" }"
}
...
class SponsorsActivityOrder(val direction: OrderDirection, val field: SponsorsActivityOrderField) {
    override fun toString() = "{ direction: $direction, field: $field }"
}
...
class UpdateOrganizationAllowPrivateRepositoryForkingSettingInput(val clientMutationId: String? = null, val forkingEnabled: Boolean, val organizationId: ID) {
...
class UpdatePullRequestBranchInput(val clientMutationId: String? = null, val expectedHeadOid: GitObjectID? = null, val pullRequestId: ID) {
    override fun toString() = "{ clientMutationId: \"$clientMutationId\", expectedHeadOid: \"$expectedHeadOid\", pullRequestId: \"$pullRequestId\" }"
}
...
class UpdateSponsorshipPreferencesInput(val clientMutationId: String? = null, val privacyLevel: SponsorshipPrivacy? = null, val receiveEmails: Boolean? = null, val sponsorId: ID? = null, val sponsorLogin: String? = null, val sponsorableId: ID? = null, val sponsorableLogin: String? = null) {
    override fun toString() = "{ clientMutationId: \"$clientMutationId\", privacyLevel: $privacyLevel, receiveEmails: $receiveEmails, sponsorId: \"$sponsorId\", sponsorLogin: \"$sponsorLogin\", sponsorableId: \"$sponsorableId\", sponsorableLogin: \"$sponsorableLogin\" }"
}
